...
module.exports = function build(parameter) {
	...
	return {
		"entry": parameter.test ? "./test.js" : "./header-divider.support.js",
		...
		"output": {
			"library": parameter.test ? "test" : "header-divider",
			"libraryTarget": "umd",
			"filename": parameter.test ? "test.deploy.js" : "header-divider.deploy.js"
		},
